...
public class EnemyUtil {
    ...
    public static bool CanSee (Vector2 initialPosition, Vector2 targetPosition, bool mustBeOnScreen = true)
    {
        return (!mustBeOnScreen || IsOnScreen(initialPosition)) && Physics2D.Linecast(initialPosition, targetPosition,
